...
#more confidence in the model, we have to test it by selecting samples (say 40) and manually recalculate the rates for that
#samples selected and compare them to the output generated by our module.  Because of time constraint, we will not do that in this iteration
#but will do the testing at a later time.
