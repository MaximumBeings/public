...
from the pseudocode from the book - A primer for the Mathematics of Financial Engineering and
the code will only work for a call option.  In the near future, we will create a similar for a put
and finally combine them.  In order to ensure the accuracy of the code, we compared to the result
