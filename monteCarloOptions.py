...
of the default behavior which gives you same random numbers unless you set a seed thus giving you the illusion that the 
...
code used Box Muller algorithm, which I converted to python (see below) but my implementation is slow so I used scipy 
