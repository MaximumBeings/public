...
SOURCE: Advanced Quantitative Finance with C++ By Alonso Peña, Ph.D. (Chapter Four)
...
normal random number generator to generate random numbers with gaussion distribution (after a bit of googling of course).  Using scipy makes
it much faster but not as fast as C++ but very very close (I guess there are libraries for C++ as well).  See you next 
