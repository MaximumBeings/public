...
TITLE: Valuing Interest Rate Swaps Using OIS Discounting (Part C)
...
def ratePrinter():
    print ""
    print "ORIGINAL RATE, LIBOR DISCOUNT RATE AND LIBOR IMPLIED FORWARD RATE"
...
oisImpFR = LIBOR = deepcopy(ifrOISCalculator())
...
#To Calculate the Market Value of Swap = Market Value of Fixed Leg = Market Value of Floating Leg
def swapMarketValueOIS():
    return fixedRateLegOIS() - floatingRateLegOIS()
...
print "_____________________________________________"
print ""
print ("Market Value of Fixed Rate Leg = ") + str(locale.currency(fixedRateLegOIS(),grouping=True))
print ""
print ("Market Value of Floating Rate Leg = ") + str(locale.currency(floatingRateLegOIS(),grouping=True))
print ""
print ("Market Value of Swap: (MV Fixed - MV FRN) = ") + str(locale.currency(swapMarketValueOIS(),grouping=True))



"""
FINAL RESULTS FOR LIBOR & OIS DISCOUNTING:
___________________________________________


ORIGINAL RATE, LIBOR DISCOUNT RATE AND LIBOR IMPLIED FORWARD RATE
